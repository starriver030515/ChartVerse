...
MODEL_PATH="starriver030515/ChartVerse-2B-SFT-Only"
...
# Paths and namings
project_name="chartverse"
SFT_MODEL=$(basename $MODEL_PATH)

DATA_FOLDER=YOUR_DATA_FOLDER_PATH_HERE  # TODO: set your data folder path here
...
PROJECT_FOLDER=training/$experiment_name

python3 -m verl.trainer.main_ppo \
    algorithm.adv_estimator=${adv_estimator} \
    actor_rollout_ref.actor.policy_loss.loss_mode=${loss_mode} \
    data.train_files=[$DATA_FOLDER/chartverse_rl_40k.parquet] \
    data.val_files=${DATA_FOLDER}/Your_VAL_FILE.parquet \
